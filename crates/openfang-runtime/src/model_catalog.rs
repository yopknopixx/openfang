...
fn builtin_providers() -> Vec<ProviderInfo> {
    vec![
        ...
        ProviderInfo {
            ...
            api_key_env: "DO_API_KEY".into(),
            base_url: "https://inference.do-ai.run/v1".into(),
            key_required: true,
            auth_status: AuthStatus::Missing,
            model_count: 0,
        },
...
fn builtin_models() -> Vec<ModelCatalogEntry> {
    vec![
        ...
        // ══════════════════════════════════════════════════════════════
        ModelCatalogEntry {
            id: "do/llama3.3-70b-instruct".into(),
            display_name: "Llama 3.3 70B (DO)".into(),
            ...
            supports_vision: false,
            supports_streaming: true,
            aliases: vec!["do-llama70b".into()],
        },
        ModelCatalogEntry {
            id: "do/llama3-8b-instruct".into(),
            display_name: "Llama 3 8B (DO)".into(),
            provider: "digitalocean".into(),
            tier: ModelTier::Fast,
            context_window: 8192,
            max_output_tokens: 2048,
            input_cost_per_m: 0.095,
            output_cost_per_m: 0.095,
            supports_tools: true,
            supports_vision: false,
            supports_streaming: true,
            aliases: vec!["do-llama8b".into()],
        },
        ModelCatalogEntry {
            id: "do/mistral-nemo-instruct".into(),
            display_name: "Mistral NeMo (DO)".into(),
            provider: "digitalocean".into(),
            tier: ModelTier::Fast,
            context_window: 131_072,
            max_output_tokens: 4096,
            ...
            supports_vision: false,
            supports_streaming: true,
            aliases: vec!["do-nemo".into()],
        },
        ModelCatalogEntry {
            id: "do/deepseek-r1-distill-70b".into(),
            display_name: "DeepSeek R1 Distill 70B (DO)".into(),
            provider: "digitalocean".into(),
            tier: ModelTier::Smart,
            context_window: 131_072,
            max_output_tokens: 4096,
            ...
            supports_vision: false,
            supports_streaming: true,
            aliases: vec!["do-r1".into()],
        },
        ModelCatalogEntry {
            id: "do/qwen3-32b".into(),
            display_name: "Qwen3 32B (DO)".into(),
            provider: "digitalocean".into(),
            tier: ModelTier::Smart,
            context_window: 131_072,
            max_output_tokens: 4096,
            ...
            supports_vision: false,
            supports_streaming: true,
            aliases: vec!["do-qwen".into()],
        },
        ModelCatalogEntry {
            id: "do/gpt-oss-120b".into(),
            display_name: "GPT-OSS 120B (DO)".into(),
            provider: "digitalocean".into(),
            tier: ModelTier::Smart,
            context_window: 131_072,
            max_output_tokens: 4096,
            ...
            supports_vision: false,
            supports_streaming: true,
            aliases: vec!["do-gpt-oss".into()],
        },
        ModelCatalogEntry {
            id: "do/gpt-oss-20b".into(),
            display_name: "GPT-OSS 20B (DO)".into(),
            provider: "digitalocean".into(),
            tier: ModelTier::Fast,
            context_window: 131_072,
            max_output_tokens: 4096,
            ...
            supports_vision: false,
            supports_streaming: true,
            aliases: vec!["do-gpt-oss-20b".into()],
        },
    ]
}
